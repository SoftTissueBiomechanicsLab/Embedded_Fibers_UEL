function AbaqusData = ReadAbaqusReportsRPL(cur_path, JobNum,RPL)
...
Field_file = [full_workdir,'Model',IDStr,RPL,'_Fields.csv'];
History_file = [full_workdir,'Model',IDStr,RPL,'_History.csv'];
...
while line>=0
    ...
    if contains(line,'Instance,  Element ,    Node  , SP, IP,      S11     ,      S22     ,      S33     ,      S12     ,      S13     ,      S23     ')
        ...
        temp = temp(1:end-1); % the last is the beginning of the beams
