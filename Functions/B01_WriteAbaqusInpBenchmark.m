function [] = B01_WriteAbaqusInpBenchmark(WorkDir, JobNum, SolidMesh, BeamMesh, PenaltyConst, BeamRadius, param_beam, nSteps, Matl, param_solid, CoupleElemCon, nmax, nT, SolverOptions, FyTraction)
...
for i = 1:nh
    fprintf(fid, '*BEAM SECTION, ELSET=BeamElem%d, material=NeoHookeanBeam, section=CIRC \n',i);
    fprintf(fid, '%2.7e \n', BeamRadius);
...
for i = 1:nSteps
    ...
    fprintf(fid, 'FixBeamSet, ENCASTRE \n');
    fprintf(fid, '*DSLOAD \n');
    fprintf(fid, 'Xp_Face,TRVEC, %2.12e, 0.0, 1.0, 0.0 \n', StepTraction(i));
