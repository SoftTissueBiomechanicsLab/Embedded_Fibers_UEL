function [] = WriteAbaqusInputFile(WorkDir, JobNum, SolidMesh, BeamMesh, PenaltyConst, BeamRadius, param_beam, X_disp, nSteps, Matl, param_solid, beam_nu, CoupleElemCon, nmax, nT, SolverOptions, RPL)
...
if strcmp(RPL, 'UEx') || strcmp(RPL, 'SSxy') || strcmp(RPL, 'SSxz')
    fprintf(fid, '\t %i, %2.14e, %2.14e, %2.14e \n', [ntotal+1, -0.1*W, D/2, H/2]);
    fprintf(fid, '\t %i, %2.14e, %2.14e, %2.14e \n', [ntotal+2, 1.1*W, D/2, H/2]);
elseif strcmp(RPL, 'UEy') || strcmp(RPL, 'SSyx') || strcmp(RPL, 'SSyz')
    fprintf(fid, '\t %i, %2.14e, %2.14e, %2.14e \n', [ntotal+1, W/2, -0.1*D, H/2]);
    fprintf(fid, '\t %i, %2.14e, %2.14e, %2.14e \n', [ntotal+2, W/2, 1.1*D, H/2]);
elseif strcmp(RPL, 'UEz') || strcmp(RPL, 'SSzx') || strcmp(RPL, 'SSzy')
...
for i = 1:nSteps
    ...
    elseif strcmp(RPL, 'SSyx') || strcmp(RPL, 'SSzx') 
        fprintf(fid, 'FreeRefNode, 1,1,%.3e \n',StepDisp(i));
        fprintf(fid, 'FreeRefNode, 2,6\n');
    elseif strcmp(RPL, 'SSxy') || strcmp(RPL, 'SSzy') 
        fprintf(fid, 'FreeRefNode, 1,1 \n');
        fprintf(fid, 'FreeRefNode, 2,2,%.3e \n',StepDisp(i));
        fprintf(fid, 'FreeRefNode, 3,6\n');
    elseif strcmp(RPL, 'SSxy') || strcmp(RPL, 'SSzy') 
